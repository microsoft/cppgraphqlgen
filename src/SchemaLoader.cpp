...
void SchemaLoader::TypeVisitor::visit(const peg::ast_node& typeName)
{
...
void SchemaLoader::TypeVisitor::visitNamedType(const peg::ast_node& namedType)
{
	if (!_nonNull)
	{
...
void SchemaLoader::TypeVisitor::visitListType(const peg::ast_node& listType)
{
	if (!_nonNull)
	{
		_modifiers.push_back(service::TypeModifier::Nullable);
...
void SchemaLoader::TypeVisitor::visitNonNullType(const peg::ast_node& nonNullType)
{
	_nonNull = true;
...
std::pair<std::string_view, TypeModifierStack> SchemaLoader::TypeVisitor::getType()
{
	return { std::move(_type), std::move(_modifiers) };
}

void SchemaLoader::DefaultValueVisitor::visit(const peg::ast_node& value)
{
...
void SchemaLoader::DefaultValueVisitor::visitIntValue(const peg::ast_node& intValue)
{
	_value = response::Value(std::atoi(intValue.string().c_str()));
}

void SchemaLoader::DefaultValueVisitor::visitFloatValue(const peg::ast_node& floatValue)
{
	_value = response::Value(std::atof(floatValue.string().c_str()));
}

void SchemaLoader::DefaultValueVisitor::visitStringValue(const peg::ast_node& stringValue)
{
	_value = response::Value(std::string { stringValue.unescaped_view() });
}

void SchemaLoader::DefaultValueVisitor::visitBooleanValue(const peg::ast_node& booleanValue)
{
	_value = response::Value(booleanValue.is_type<peg::true_keyword>());
}

void SchemaLoader::DefaultValueVisitor::visitNullValue(const peg::ast_node& /*nullValue*/)
{
	_value = {};
}

void SchemaLoader::DefaultValueVisitor::visitEnumValue(const peg::ast_node& enumValue)
{
	_value = response::Value(response::Type::EnumValue);
	_value.set<response::StringType>(enumValue.string());
}

void SchemaLoader::DefaultValueVisitor::visitListValue(const peg::ast_node& listValue)
{
...
void SchemaLoader::DefaultValueVisitor::visitObjectValue(const peg::ast_node& objectValue)
{
...
response::Value SchemaLoader::DefaultValueVisitor::getValue()
{
...
const SchemaType& SchemaLoader::getSchemaType(std::string_view type) const
{
