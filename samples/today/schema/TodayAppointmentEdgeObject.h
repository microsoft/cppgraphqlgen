...
#ifndef TODAY_TODAYAPPOINTMENTEDGEOBJECT_H
#define TODAY_TODAYAPPOINTMENTEDGEOBJECT_H
...
public:
	template <class T>
	explicit AppointmentEdge(std::shared_ptr<T> pimpl) noexcept
...
#endif // TODAY_TODAYAPPOINTMENTEDGEOBJECT_H
