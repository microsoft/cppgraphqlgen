...
#ifndef TODAY_TODAYTASKEDGEOBJECT_H
#define TODAY_TODAYTASKEDGEOBJECT_H
...
public:
	template <class T>
	explicit TaskEdge(std::shared_ptr<T> pimpl) noexcept
...
#endif // TODAY_TODAYTASKEDGEOBJECT_H
